                 ...
                 },
                 {
                     ...
                     callback: function () {
                         ...
                         if (settings.callback)
                             settings.callback(_get_base64_value(), 'Limpiar');
                     }
                 },
                 {
                     title: 'Aceptar',
                     callback: function () {
                         ...
                         big_pad.slideToggle(function () {
                             back_drop.hide('fade', function () {
                                 if (settings.callback)
                                     settings.callback(_get_base64_value(), 'Aceptar');
                             });
                         });
                     }
                 }].forEach(function (e) {
                     ...
                     btn.css('border', '3px solid #ef3829');
                     btn.css('background-color', '#ef3829');
